...
> 작성일: 2026-02-18
> 목표: 런칭 7일 내 UV 500+, 카드 생성 200+, 공유율 20%+
...
[6] 다시 공유 → ✅
```
**병목: 3번 — OG 이미지가 제네릭이라 피드에서 호기심을 자극하지 못함**
...
|------|------|-----------|------------|
| UV (유니크 방문) | page_view 고유 | 500 | 3,000 |
| 카드 생성 수 | card_generated | 200 | 1,200 |
| 입력 전환율 | 생성/방문 | 40% | 40% |
| 공유율 | 공유/생성 | 20% | 25% |
| 다운로드율 | 다운로드/생성 | 15% | 20% |
| 바이럴 계수 (K) | 공유유입/공유 | 0.5 | 0.7 |
...
| 등급 | 기준 | 판단 |
|------|------|------|
| 🟢 성공 | UV 500+, 생성 200+, 공유율 20%+ | Phase 2 확장 진행 |
| 🟡 보통 | UV 200-500, 생성 80-200, 공유율 10-20% | 카피/채널 피봇 후 재시도 |
...
| 0.5 ≤ K < 1.0 | 시딩+바이럴 혼합 | 시딩 지속 + 공유 UX 개선 |
| K < 0.5 | 시딩 의존 | 카피 변경, CTA 강화, 다운로드 푸시 |
