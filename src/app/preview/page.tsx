      ...
      >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          {([
            ...
            { key: 'hp' as const, label: 'HP', min: 100, max: 600, color: '#ef4444' },
            { key: 'mp' as const, label: 'MP', min: 80, max: 500, color: '#8b5cf6' },
            { key: 'str' as const, label: 'STR', min: 50, max: 400, color: '#f97316' },
            { key: 'int' as const, label: 'INT', min: 50, max: 400, color: '#60a5fa' },
